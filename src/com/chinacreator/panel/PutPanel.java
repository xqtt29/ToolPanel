...
import com.chinacreator.Action.PutAction;
...
public class PutPanel {
	...
	public PutPanel(){
		...
		button.addActionListener(new PutAction(textOutPut, textThreadCounts,labPic, textUrl, textProp, textParam,boxProxy));
	 ...
	 * @param title tab页标题
	 */
	public void createPutJPanel(final JTabbedPane tabbedPane,String title){
		//添加tab页面
	 ...
	 * @param textProp 属性
	 */
	public void createPutJPanel(final JTabbedPane tabbedPane,String title,String textUrl,String textParam,String textProp){
