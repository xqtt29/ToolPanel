...
import com.chinacreator.Action.DeleteAction;
...
public class DeletePanel {
	...
	public DeletePanel(){
		...
		button.addActionListener(new DeleteAction(textOutPut, textThreadCounts,labPic, textUrl, textProp, textParam,boxProxy));
	 ...
	 * @param title tab页标题
	 */
	public void createDeleteJPanel(final JTabbedPane tabbedPane,String title){
		//添加tab页面
	 ...
	 * @param textProp 属性
	 */
	public void createDeleteJPanel(final JTabbedPane tabbedPane,String title,String textUrl,String textParam,String textProp){
