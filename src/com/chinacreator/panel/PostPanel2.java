...
import com.chinacreator.Action.PostAction2;
...
public class PostPanel2 {
	...
	public PostPanel2(){
		...
		button.addActionListener(new PostAction2(textOutPut, textThreadCounts,labPic, textUrl, textProp, textParam,boxProxy));
	 ...
	 * @param textProp 属性
	 */
	public void createPostJPanel(final JTabbedPane tabbedPane,String title,String textUrl,String textParam,String textProp){
